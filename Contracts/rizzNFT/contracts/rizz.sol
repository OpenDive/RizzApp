...
contract RizzaERC1155 is ERC1155, ERC1155Supply {
    ...
    function reedemMint(
        ...
        address signer = recoverSigner(receiver, id, sig);
        require(verifyProof(signer, merkle_roots[id], proof), "invalid signer");
    ...
    function ProxyMint(address receiver, uint256 id) external {
    ...
    function AdminUpdate(uint256 id, uint256 _limit, bytes32 _root) external {
